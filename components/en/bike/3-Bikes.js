		...
		<div id="tools" className="w-full max-w-[1300px] m-auto h-full p-2 items-center py-32">
			...
			<div className="grid lg:grid-cols-2 gap-8 ">
				...
				<div className="p-4 m-auto max-w-[450px] xl:w-[550px] justify-center items-center grid grid-cols-2 gap-2 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
					...
					/>
					<p className="text-sm">
						Usual adjustments. Spokes tightening. Headset lubrication. Saddle, stem and
				...
				<div className="p-4 m-auto max-w-[450px] xl:w-[550px] justify-center items-center grid grid-cols-2 gap-2 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
					...
					/>
					<p className="text-sm">
						Usual adjustments. Pedals, stem, handlebars, brake levers and saddle
				...
				<div className="p-4 m-auto max-w-[450px] xl:w-[550px] justify-center items-center grid grid-cols-2 gap-2 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
					...
					/>
					<p className="text-sm">
						Usual adjustments. Switch to single-speed. Installation of accessories and
						brake adjustment.
					</p>
				</div>
				<div className="p-4 m-auto max-w-[450px] xl:w-[550px] justify-center items-center grid grid-cols-2 gap-2 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
				...
				<div className="p-4 m-auto max-w-[450px] xl:w-[550px] justify-center items-center grid grid-cols-2 gap-2 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
					<img
						...
						className="rounded-xl"
					/>
					<p className="text-sm">Usual adjustments. (Yes, that's me in the picture)</p>
				</div>
			</div>
		</div>
	);
