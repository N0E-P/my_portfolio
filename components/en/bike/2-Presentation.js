		...
		<div id="presentation" className="w-full p-4 items-center">
			<div className="max-w-[1400px] m-auto ">
				...
				<h1 className="mb-12 mt-6 max-w-[285px] sm:max-w-[1400px] m-auto">
					But I <span className="underline underline-offset-4">always</span> wanted to
					improve.
				</h1>
				...
				<div className="max-w-[1325px] m-auto">
					...
					<p className="sm:mx-10 my-2 p-4 ">
						I bought cryptos that didn't make sense, I played trader when I didn't know
						anything about it, and I lost unbelievable amounts of money just on
						transaction fees. In short, I managed to make all my money disappear without
