        ...
        <div className="xl:grid grid-cols-3 mt-2 sm:mt-5 xl:mt-10">
          <div className="col-span-2 xl:mr-8">
            <p className="py-2 text-gray-700 ">
              After doing these first 5 projects, it was time for me to try to
              find work by showing what I had learned, built and accomplished.
              At the same time, I also wanted to know how to make better
              websites. So I decided to create my portfolio.
            </p>
            <p className="py-2 text-gray-700 ">
              In mid-August, I started building. I did it with React, NextJS and
              Tailwind, because I had already used them in the Solidity &
              Javascript training. I also watched a 2H30 Youtube tutorial to
              learn more about it.
            </p>
            <p className="py-2 text-gray-700 ">
              Once finished, it was now time to go look for companies that would
              appreciate hiring me.
            </p>
          </div>
